#ifndef __FILTER_FUNCTIONS_HLSLI__
#define __FILTER_FUNCTIONS_HLSLI__

//--------------------------------------------
//	RGB色空間の数値からHSV色空間の数値への変換関数
//--------------------------------------------
//rgb:RGB色空間の数値
float3 convert_rgb_to_hsv( float3 rgb )
{
	float3 hsv = 0;
...
//--------------------------------------------
//hsv:HSV色空間の数値
float3	convert_hsv_to_rgb( float3 hsv )
{
	float3 rgb = 0;
	if (hsv.y == 0)
	{
