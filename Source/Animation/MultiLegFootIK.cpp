...
void MultiLegFootIK::SetRay(float up, float down, float contactOffset)
{
	rayUp = up;
	rayDown = down;
...
bool MultiLegFootIK::HasGroundContact() const
{
...
void MultiLegFootIK::UpdateModelTransform()
{
...
float MultiLegFootIK::GetFootIKWeight(int footIndex) const
{
